      ...
      <main style={{ maxWidth: 760, margin: "0 auto", padding: "52px 24px 80px" }}>
        ...
        <div style={{ marginBottom: 36 }}>
          ...
          <p style={{ fontSize: 14, color: "#64748b", lineHeight: 1.7, margin: 0, maxWidth: 520 }}>
            Paste any text below. Multiple GenLayer validators will independently analyze it
            and reach consensus on whether it was written by a human or generated by AI.
          </p>
        </div>

        {/* Form or connect prompt */}
        {address ? (
          <SubmitCheck address={address} mode="ai_detection" />
        ) : (
          <ConnectPrompt />
        )}
      </main>
